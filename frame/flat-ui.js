   ...
   */
    ...
    AbstractSelect2 = clazz(Object, {
                    ...
                    populate=function(results, container, depth) {
                        ...
                        for (i = 0, l = results.length; i < l; i = i + 1) {
                            ...
                            if (formatted!==undefined) {
								...
								label.attr("title", formatted.split('</span>')[1]);
                                node.append(label);
                            }
        ...
        opening: function() {
			...
			this.container.children('a').children('.select2-arrow').addClass('select2-arrow-top');
			this.container.children('a').addClass('select2-choice-active');
        ...
        close: function () {
			...
			this.container.children('a').children('.select2-arrow').removeClass('select2-arrow-top').removeClass('select2-arrow-active');
			this.container.children('a').removeClass('select2-choice-active');
            this.results.empty();
    ...
    SingleSelect2 = clazz(AbstractSelect2, {
        ...
        createContainer: function () {
            var container = $(document.createElement("div")).attr({
                ...
                "   <span class='select2-arrow select2-arrow-bottom' role='presentation'><b role='presentation'></b></span>",
                "</a>",
